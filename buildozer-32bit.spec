...
requirements = python311,kivy==2.2.1,kivymd,https://github.com/kivymd/KivyMD/archive/3274d62.zip,sdl2_ttf==2.0.15
...
osx.python_version = 311

# Kivy version to use
osx.kivy_version = 2.2.11
